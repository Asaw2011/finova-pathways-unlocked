...
export const modules = [
  ...
  },
  {
    ...
    lessons: [
      { id: "if-1", title: "Why Invest?", xp: 10, content: "Investing means putting money into assets that can grow over time. Historically, the stock market returns ~7-10% per year.", takeaway: "Investing grows your money; saving just protects it.", quiz: [{ q: "Investing is best for:", options: ["Next week's expenses", "Long-term wealth building", "Emergency funds", "Daily spending"], answer: 1 }, { q: "The stock market historically returns:", options: ["1-2% per year", "7-10% per year", "50% per year", "0%"], answer: 1 }] },
      { id: "if-2", title: "Stocks 101", xp: 10, content: "A stock represents ownership in a company. When a company grows, its stock price usually rises.", takeaway: "Owning stock means owning a piece of a company.", quiz: [{ q: "A stock represents:", options: ["A loan to a company", "Ownership in a company", "A government bond", "A savings account"], answer: 1 }, { q: "Fractional shares let you:", options: ["Buy part of a stock for less money", "Get free stocks", "Avoid all risk", "Skip market hours"], answer: 0 }] },
      { id: "if-3", title: "Bonds & Fixed Income", xp: 10, content: "Bonds are loans you make to governments or companies. They pay you back with interest over a set period.", takeaway: "Bonds are the stable part of your portfolio.", quiz: [{ q: "Bonds are essentially:", options: ["Ownership in a company", "Loans you make to others", "Savings accounts", "Insurance policies"], answer: 1 }, { q: "Compared to stocks, bonds are:", options: ["Higher risk, higher return", "Lower risk, lower return", "No risk, no return", "Exactly the same"], answer: 1 }] },
      { id: "if-4", title: "ETFs & Index Funds", xp: 10, content: "ETFs bundle many stocks together. An S&P 500 ETF gives you exposure to 500 of America's largest companies.", takeaway: "ETFs let you invest in many companies at once.", quiz: [{ q: "ETF stands for:", options: ["Electronic Transfer Fund", "Exchange-Traded Fund", "Extra Tax Filing", "Emergency Trust Fund"], answer: 1 }, { q: "Index funds are recommended for beginners because:", options: ["They guarantee profits", "They provide diversification with low fees", "They're free", "They never lose value"], answer: 1 }] },
      { id: "if-5", title: "The Power of Compound Growth", xp: 10, content: "Compound growth means your returns earn returns. Starting earlier makes a massive difference.", takeaway: "Time is the most powerful tool in investing — start now.", quiz: [{ q: "Compound growth earns returns on:", options: ["Only the original amount", "Interest + principal", "Just the interest", "Nothing"], answer: 1 }, { q: "Starting to invest earlier means:", options: ["Less total growth", "More time for compounding", "Higher risk", "Lower returns"], answer: 1 }] },
    ],
    unitQuiz: [
  ...
  },
  {
    ...
    lessons: [
      { id: "bw-1", title: "Income vs Wealth", xp: 10, content: "Income is money you earn; wealth is money you keep and grow. High income doesn't guarantee wealth.", takeaway: "It's not what you earn, it's what you keep.", quiz: [{ q: "Wealth is measured by:", options: ["Your salary", "Assets minus liabilities", "Your job title", "How much you spend"], answer: 1 }, { q: "High income guarantees wealth:", options: ["Always true", "Sometimes true", "False — spending matters more", "Only for millionaires"], answer: 2 }] },
      { id: "bw-2", title: "Multiple Income Streams", xp: 10, content: "Relying on one income source is risky. Side hustles, freelancing, and investments create financial resilience.", takeaway: "Don't put all your eggs in one basket — diversify income.", quiz: [{ q: "Multiple income streams provide:", options: ["More stress", "Financial resilience", "Tax problems always", "Less free time always"], answer: 1 }, { q: "Passive income comes from:", options: ["Active work only", "Investments and assets", "Borrowing money", "Government aid"], answer: 1 }] },
      { id: "bw-3", title: "The Millionaire Mindset", xp: 10, content: "Most millionaires are first-generation wealthy — they built it themselves through discipline.", takeaway: "Wealth is built through discipline, not luck.", quiz: [{ q: "Most millionaires build wealth through:", options: ["Lottery winnings", "Discipline over decades", "Inheritance only", "Day trading"], answer: 1 }, { q: "Lifestyle inflation means:", options: ["Saving more as you earn more", "Spending more as you earn more", "Investing all raises", "Reducing expenses"], answer: 1 }] },
      { id: "bw-4", title: "Avoiding Lifestyle Inflation", xp: 10, content: "When your income rises, resist the urge to upgrade everything. Save 50% of every raise.", takeaway: "Save your raises — live on your old salary, invest the new money.", quiz: [{ q: "When you get a raise, you should:", options: ["Upgrade your car immediately", "Save at least 50% of the increase", "Spend it all as a reward", "Quit your job"], answer: 1 }, { q: "Lifestyle inflation is:", options: ["Good for building wealth", "The #1 wealth killer for earners", "Unavoidable", "Only for rich people"], answer: 1 }] },
      { id: "bw-5", title: "Net Worth Tracking", xp: 10, content: "Net worth = assets minus liabilities. Track it monthly. The trend matters more than the number.", takeaway: "What gets measured gets managed — track your net worth.", quiz: [{ q: "Net worth equals:", options: ["Income minus expenses", "Assets minus liabilities", "Salary times years worked", "Total savings only"], answer: 1 }, { q: "A negative net worth means:", options: ["You're a failure", "You should give up", "Your liabilities exceed assets — focus on the trend", "You can never build wealth"], answer: 2 }] },
    ],
    unitQuiz: [
