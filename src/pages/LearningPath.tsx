...
export const modules = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: "cd-4", title: "How Interest Charges Work", xp: 10, videoId: "EJMEMaMtRto", content: "APR is the yearly interest rate on borrowed money. Credit card APRs average 20-25%.", takeaway: "Pay in full each month to avoid interest charges.", quote: { text: "Beware of little expenses.", author: "Benjamin Franklin" }, example: "A $1,000 balance at 24% APR with $25 minimum payments takes 62 months.", quiz: [{ q: "APR stands for:", options: ["Annual Payment Rate", "Annual Percentage Rate", "Average Payment Required", "Automatic Payment Refund"], answer: 1 }, { q: "To minimize interest on credit cards:", options: ["Pay minimums only", "Pay the full balance", "Open more cards", "Skip payments"], answer: 1 }] },
