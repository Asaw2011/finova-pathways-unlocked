        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-12">
            {[
              ...
              { icon: Heart, title: "Accessible to All", desc: "Core courses are free. School programs are affordable. No teen gets left behind." },
          ...
          <div className="glass rounded-xl p-8">
            ...
            <p className="text-muted-foreground mb-6">
              FinOva is built by a team of financial professionals, educators, and technologists passionate about youth financial empowerment. We partner with the Financial Freedom Initiative to bring workshops, mentorship, and community outreach to students nationwide.
            </p>
