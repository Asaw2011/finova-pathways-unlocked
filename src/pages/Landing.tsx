      ...
      <S className="py-16 sm:py-24 px-4 sm:px-6 bg-card border-y border-border texture-grid" id="pricing">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 sm:mb-16 reveal">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-xl mx-auto">Every core feature is free. Monucate Plus unlocks premium perks for power learners.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
            ...
            <div className="reveal gradient-border p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-background">
              ...
              <h3 className="text-xl sm:text-2xl font-black mb-1" style={{ fontFamily: "var(--font-display)" }}>Monucate <span className="gradient-text">Plus</span></h3>
      ...
      <footer className="py-10 sm:py-16 px-4 sm:px-6 border-t border-border bg-card">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-border pt-6 sm:pt-8 text-center">
            <p className="text-[10px] sm:text-xs text-muted-foreground">&copy; {new Date().getFullYear()} Monucate. All rights reserved.</p>
